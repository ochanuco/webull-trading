...
- `WEBULL_ACCOUNT_ID_JP_CASH` (required — US_MARGIN account id; JP CASH is not wired in the bridge)
...
```bash
for key in WEBULL_APP_KEY WEBULL_APP_SECRET WEBULL_ACCOUNT_ID_JP_CASH \
